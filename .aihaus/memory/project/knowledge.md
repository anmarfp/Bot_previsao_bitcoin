...
- Verified: `gerar_json` never gives up on unavailability. HTTP 429/500/502/503/504 and network errors are retried without limit, waiting min(20 s × n, 300 s); a timeout (the client is created with a 120 s timeout) waits 180 s and retries. Only invalid or validator-rejected JSON is limited to 5 attempts, and non-temporary codes (e.g. 400/401/403) fail at once. Owner decision: Marco, 2026-09-22, after the 22:00 run failed with 503 on all 5 attempts. Source: `robot_bitcoin.py` (reviewed 975a58f).
